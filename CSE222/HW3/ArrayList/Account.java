...
public class Account{
    ...
    public Account(int accountId, String username, String birthdate, String location){
        ...
        this.inboxMessages = new ArrayList<Message>();
        this.outboxMessages = new ArrayList<Message>();
     ...
     */
    public void login(ArrayList<Account> currentAccounts){
     ...
     * @param currentAccounts The Accounts that has been created so far.
     */
    public void viewInteractions(Account user, ArrayList<Account> currentAccounts){
        if(this.isLogin()){
            if(user.posts != null){
                for(int i=0; i<user.posts.size(); ++i){
     ...
     * 
     * @param user The Account user who will be unblocked.
     */
     ...
     * @param currentAccounts The Accounts that has been created so far.
     */
    public void viewOutbox(ArrayList<Account> currentAccounts){
        if(this.isLogin()){
     ...
     * @param currentAccounts The Accounts that has been created so far.
     */
    public void viewInbox(ArrayList<Account> currentAccounts){
        if(this.isLogin()){
